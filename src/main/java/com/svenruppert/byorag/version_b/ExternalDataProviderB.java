...
public class ExternalDataProviderB {

  private ExternalDataProviderB() {
  }
  ...
  private static List<Person> dataSetA() {
    ...
    anna.info().add("Anna owns a sleeping bag with a comfort rating of -5°C");
  ...
  private static List<Person> dataSetB() {
    ...
    var anna = new Person("Anna", new HashSet<>());
    anna.info().add("she owns a sleeping bag with a comfort rating of -5°C");
